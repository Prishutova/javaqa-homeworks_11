...
public class TodosTest {
  @Test
    ...
    @Test
    public void shouldFindFewTaskFound() {
        SimpleTask simpleTask = new SimpleTask(5, "Скачать приложения");
    ...
    @Test
    public void shouldFindZeroTaskFound() {
        SimpleTask simpleTask = new SimpleTask(5, "Позвонить родителям");
    ...
    @Test
    public void shouldFindWithEmptyQuery() {
